...
import com.example.myapplication.dataAccess.PasswordEncryption;
...
public class AuthentificationActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void signUp() {
        ...
        if (selectedId == R.id.agentRadio) {
            userType = "agent"; // The user is registering as an agent
        } else if (selectedId == R.id.clientRadio) {
            userType = "client"; // The user is registering as a client
        } else {
